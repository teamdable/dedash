...
- Front 없이 Backend만 빌드
```
IMAGE_TAG="10.0.0.b50363-TrinoAnnotate-Metric-8"
...
docker build --build-arg skip_frontend_build=true -t 740271638955.dkr.ecr.ap-northeast-2.amazonaws.com/dable/redash:${IMAGE_TAG} .
