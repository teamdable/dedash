...
```bash
# ECR 태그 추가
docker tag redash:x86 740271638955.dkr.ecr.ap-northeast-2.amazonaws.com/dable/redash:25.8.0-Dable-0.0.7
...
# ECR에 이미지 푸시
docker push 740271638955.dkr.ecr.ap-northeast-2.amazonaws.com/dable/redash:25.8.0-Dable-0.0.7
```

## 빌드 완료 정보

- **이미지**: `740271638955.dkr.ecr.ap-northeast-2.amazonaws.com/dable/redash:25.8.0-Dable-0.0.7`
- **플랫폼**: `linux/amd64`
